class LikesController < ApplicationController
  def create
    ...
    if @like.save
      redirect_back fallback_location: root_path, notice: "You liked #{@liked_post.author.email}'s post."
    else
  ...
  def destroy
    ...
    @like.destroy
    redirect_back fallback_location: root_path, notice: "You unliked #{@liked_post.author.email}'s post."
  end
end
